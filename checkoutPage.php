			...
			<div class="container">
				...
				<div class="new-arrivals-content">
					<div class="row">
							...
							<tbody>
								<?php
									foreach ($_SESSION['cart'] as $key=>$value) {
										...
										echo "<td>";
										echo "<img width='300px' height='auto' src='". $value['imageLink'] ."''></img>";
										echo "</td>";
										...
										echo "<td>";
										echo  getPrice($value['price']) * $value['quantity'];
										echo "</td>";


										echo "<td>";
										echo "<form action='links/removeInCart.php' method='post'>
											<input type='submit' value='remove'>
											<input type='hidden' name='itemToRemove' value='". $key ."'>
										</form>";
										echo "</td>";
						...
						<br><br>
						<?php
							if (isset($_SESSION['username']) && $total_quan > 0) {
								echo "<form id='checkoutForm' class='container' action='links/checkout.php' method='post'>
									<div class='row'>
										<input type='hidden' name='finalCart' id='finalCart'>
										<textarea name='comment' rows='8' style='width: 100%;' placeholder='Enter Comment Here' required></textarea>
