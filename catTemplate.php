<?php
	...
	if (isset($_POST['selectedCat'])) {
		$results = $data->select("products", "prodCat='". $_POST['selectedCat'] ."'");
	}
	else{
		...
		<section id="new-arrivals" class="new-arrivals">
			<div class="container">
				<div class="section-header" style="margin-top:100px; margin-bottom: 50px;">
					<h2><?php echo $_POST['selectedCat']; ?></h2>
				</div><!--/.section-header-->
				<hr>
								...
								echo "<div class='col-md-3 col-sm-4'>
									<div class='single-new-arrival'>
										<div class='single-new-arrival-bg' >
											<img src='". $row['imageLink'] ."' alt='new-arrivals images'>
										...
										<h4><a onclick='chooseSelf(this)'>". $row['prodName'] ."</a></h4>
						...
						<div class="row justify-content-center align-items-center">
							<div class="col">
								<div class="mb-3">
								  ...
								  <input type="email" class="form-control" name="emailReg" id="emailReg" required>
								</div>
							</div>
						</div>
						<div class="row justify-content-center align-items-center">
							<div class="col">
								<div class="mb-3">
								  ...
								  <input type="text" class="form-control" name="userReg" id="userReg" aria-describedby="helpId" required>
								</div>
							</div>
						</div>
						<div class="row justify-content-center align-items-center">
							<div class="col">
								<div class="mb-3">
								  <label for="" class="form-label">Password</label>
								  <input type="password" class="form-control" name="passReg" id="passReg" aria-describedby="helpId" required>
								</div>
							</div>
						</div>
						<div class="row justify-content-center align-items-center text-center">
							<div class="col">
								<div class="mb-3">
								  ...
								  <input type="password" class="form-control" name="confirmPassword" id="confirmPassword" aria-describedby="helpId" required>
								</div>
							</div>
						</div>
					</div>
